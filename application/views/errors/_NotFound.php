...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="<?= base_url()?>assets/theme/dist/assets/css/pages/error/error-6.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed header-bottom-enabled subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?= base_url()?>assets/theme/dist/assets/media/error/bg6.jpg);">
				<!--begin::Content-->
