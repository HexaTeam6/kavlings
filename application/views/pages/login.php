...
<html lang="en">
	...
	<head>
		...
		<link href="<?= base_url()?>assets/theme/dist/assets/css/pages/login/classic/login-4.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed header-bottom-enabled subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?= base_url()?>assets/theme/dist/assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						<!--begin::Login Header-->
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="<?= base_url()?>assets/theme/dist/assets/media/logos/logo-letter-13.png" class="max-h-75px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							<div class="mb-20">
								...
								<div class="text-muted font-weight-bold">Masukkan Data Akun Anda Untuk Masuk</div>
							</div>
							<form class="form" action="<?= base_url('Auth/proses_login')?>" method="post">
								<div class="flash-data" data-flashdata="<?php echo $this->session->flashdata('login');?>"></div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Username" name="username" autofocus="" autocomplete="off" />
								</div>
								<div class="form-group mb-5">
								...
								<button type="submit" id="kt_login_signin_form" name="login_user" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4" name="login_user">Sign In</button>
							</form>
						</div>
		...
		<!-- <script src="<?= base_url()?>assets/theme/dist/assets/js/pages/custom/login/login-general.js"></script> -->
